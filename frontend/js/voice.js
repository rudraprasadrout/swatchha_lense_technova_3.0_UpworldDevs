// voice recording using the Web Speech API
// works best on Chrome and Edge - firefox has limited support
...
function toggleSpeech() {
    ...
    if (!isRecording) {
        ...
        recognition.onerror = (event) => {
            ...
            // 'no-speech' happens a lot when there's background noise, don't kill recording for that
